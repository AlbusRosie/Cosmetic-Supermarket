...
//     switch (status.toLowerCase()) {
//       case 'completed':
//         return const Color.fromARGB(255, 144, 238, 144); // Xanh lá nhạt đậm hơn (LightGreen)
//       case 'canceled':
//         return const Color.fromARGB(255, 255, 182, 193); // Đỏ nhạt đậm hơn (LightCoral)
//       case 'pending':
//         return const Color.fromARGB(255, 255, 228, 181); // Vàng nhạt đậm hơn (LightGoldenrodYellow)
//       default:
//         return const Color.fromARGB(255, 173, 216, 230); // Xanh dương nhạt đậm hơn (LightBlue)
//     }
//   }
      ...
      child: ListTile(
        ...
        title: Row(
          ...
          children: [
            ...
            const SizedBox(width: 8),
            Container(
              // Giảm kích thước tổng thể của container
